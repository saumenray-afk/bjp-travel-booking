// ====================================================================
// BJP BENGAL TRAVEL & ACCOMMODATION BOOKING SYSTEM
// ====================================================================
...
function closeWelcomeSplash() {
    ...
    if (splash) {
        splash.style.animation = 'fadeOut 0.5s ease-in-out';
        setTimeout(() => {
...
// Auto-close welcome splash after 5 seconds
function initWelcomeSplash() {
    ...
    if (splash) {
        ...
        splash.addEventListener('click', (e) => {
            if (e.target === splash || e.target.classList.contains('welcome-splash-content')) {
                closeWelcomeSplash();
            }
        });
    }
...
function openBooking(type) {
    ...
    // Generate service-specific form
    let formHTML = `
        <form id="modalBookingForm" onsubmit="submitModalBooking(event)">
            <input type="hidden" id="modalServiceType" name="serviceType" value="${config.title}">
            
            <!-- Common Fields -->
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Name <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="name" id="modalName" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">WhatsApp No. <span class="required">*</span></label>
                    <input type="tel" class="modal-form-input" name="whatsapp" id="modalWhatsapp" pattern="[0-9]{10}" maxlength="10" required>
                </div>
            </div>
    `;
    ...
    if (type === 'hotel') {
        formHTML += `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">City <span class="required">*</span></label>
                    <select class="modal-form-select" name="city" required>
                ...
                <div class="modal-form-group">
                    <label class="modal-form-label">Hotel Preference</label>
                    <input type="text" class="modal-form-input" name="hotel" placeholder="Any preferred hotel">
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Number of Rooms <span class="required">*</span></label>
                    <input type="number" class="modal-form-input" name="rooms" min="1" max="50" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">Check-in Date <span class="required">*</span></label>
                    <input type="date" class="modal-form-input" name="checkin" id="modalCheckin" required>
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Check-out Date <span class="required">*</span></label>
                    <input type="date" class="modal-form-input" name="checkout" id="modalCheckout" required>
                </div>
        ...
        formHTML += `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Venue/Location <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="venue" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">Expected Attendees <span class="required">*</span></label>
                    <input type="number" class="modal-form-input" name="attendees" min="10" required>
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Event Date <span class="required">*</span></label>
                    <input type="date" class="modal-form-input" name="date" id="modalDate" required>
                </div>
                <div class="modal-form-group"></div>
            </div>
        `;
    } else if (type === 'train' || type === 'rally') {
        formHTML += `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">From Station <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="from" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">To Station <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="to" required>
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Travel Date <span class="required">*</span></label>
                    <input type="date" class="modal-form-input" name="date" id="modalDate" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">${type === 'rally' ? 'Participants' : 'Class'} <span class="required">*</span></label>
                    ${type === 'rally' ? 
                        '<input type="number" class="modal-form-input" name="participants" min="50" required>' :
                        '<select class="modal-form-select" name="class" required><option value="">Select</option><option value="Sleeper">Sleeper</option><option value="3AC">3AC</option><option value="2AC">2AC</option><option value="1AC">1AC</option></select>'
                    }
                </div>
            </div>
            ${type === 'train' ? `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Passengers <span class="required">*</span></label>
                    <input type="number" class="modal-form-input" name="passengers" min="1" required>
                </div>
                <div class="modal-form-group"></div>
            </div>` : ''}
            ${type === 'rally' ? `
            <div class="form-row full">
                <div class="modal-form-group">
                    <label class="modal-form-label">Rally Location</label>
                    <input type="text" class="modal-form-input" name="rallyLocation">
                </div>
            </div>` : ''}
        `;
    } else if (type === 'flight' || type === 'charter') {
        formHTML += `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">From Airport <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="from" placeholder="e.g. Kolkata (CCU)" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">To Airport <span class="required">*</span></label>
                    <input type="text" class="modal-form-input" name="to" placeholder="e.g. Delhi (DEL)" required>
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
            ...
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Class <span class="required">*</span></label>
                    <select class="modal-form-select" name="class" required>
        ...
        formHTML += `
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Vehicle Type <span class="required">*</span></label>
                    <select class="modal-form-select" name="vehicleType" required>
                        <option value="">Select</option>
                ...
                <div class="modal-form-group">
                    <label class="modal-form-label">Number of Vehicles <span class="required">*</span></label>
                    <input type="number" class="modal-form-input" name="vehiclesCount" min="1" required>
                </div>
            </div>
            <div class="form-row">
                <div class="modal-form-group">
                    <label class="modal-form-label">Start Date <span class="required">*</span></label>
                    <input type="date" class="modal-form-input" name="date" id="modalDate" required>
                </div>
                <div class="modal-form-group">
                    <label class="modal-form-label">Duration (Days) <span class="required">*</span></label>
                    <input type="number" class="modal-form-input" name="duration" min="1" required>
                </div>
            </div>
        `;
    }
    ...
    formHTML += `
        <div class="form-row full">
            <div class="modal-form-group">
                ...
                <textarea class="modal-form-textarea" name="address" rows="2"></textarea>
            </div>
        </div>
        <div class="form-row">
            <div class="modal-form-group">
                <label class="modal-form-label">Aadhaar Card No.</label>
                <input type="text" class="modal-form-input" name="aadhaar" placeholder="XXXX-XXXX-XXXX" maxlength="12">
            </div>
            <div class="modal-form-group">
                <label class="modal-form-label">Designation / Responsibilities</label>
                <input type="text" class="modal-form-input" name="designation">
            </div>
        </div>
        <div class="form-row full">
            <div class="modal-form-group">
                <label class="modal-form-label">Additional Requirements / Special Requests</label>
                <textarea class="modal-form-textarea" name="requirements" rows="3" placeholder="Any special requirements..."></textarea>
            </div>
        </div>
...
async function submitModalBooking(event) {
    ...
    if (serviceType.includes('Hotel')) {
        bookingData.city = formData.get('city');
        bookingData.hotel = formData.get('hotel');
        bookingData.rooms = formData.get('rooms');
        bookingData.checkin = formData.get('checkin');
        bookingData.checkout = formData.get('checkout');
    } else if (serviceType.includes('Seminar')) {
        bookingData.venue = formData.get('venue');
        bookingData.attendees = formData.get('attendees');
        bookingData.date = formData.get('date');
    } else if (serviceType.includes('Train')) {
        bookingData.from = formData.get('from');
        bookingData.to = formData.get('to');
        bookingData.date = formData.get('date');
        bookingData.class = formData.get('class');
        bookingData.passengers = formData.get('passengers');
        ...
        bookingData.class = formData.get('class');
        bookingData.passengers = formData.get('passengers');
    } else if (serviceType.includes('Vehicle')) {
        bookingData.vehicleType = formData.get('vehicleType');
        bookingData.vehiclesCount = formData.get('vehiclesCount');
        bookingData.date = formData.get('date');
        bookingData.duration = formData.get('duration');
    } else if (serviceType.includes('Charter')) {
        bookingData.from = formData.get('from');
        bookingData.to = formData.get('to');
        bookingData.date = formData.get('date');
        bookingData.passengers = formData.get('passengers');
    } else if (serviceType.includes('Rally')) {
        bookingData.from = formData.get('from');
        bookingData.to = formData.get('to');
        bookingData.rallyLocation = formData.get('rallyLocation');
        bookingData.participants = formData.get('participants');
        bookingData.date = formData.get('date');
    }
    
    // Common optional fields
    bookingData.address = formData.get('address');
    bookingData.aadhaar = formData.get('aadhaar') ? 'XXXX-XXXX-' + formData.get('aadhaar').slice(-4) : '';
    bookingData.designation = formData.get('designation');
    bookingData.requirements = formData.get('requirements');
